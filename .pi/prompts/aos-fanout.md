...
5. Reservar archivos compartidos al orquestador (plan maestro, changelog, registry externo si existe, docs de sintesis); los workers devuelven recomendaciones y no editan esos archivos.
