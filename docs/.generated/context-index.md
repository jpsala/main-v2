...
Generated: 2026-08-26T10:46:12.518Z

## Topics

- active: [agentic-os-operations](../topics/agentic-os-operations.md) - agentic os, realinear os, auditar sistema agentico, reparar sistema agentico, actualizar os, contexto agentico
...
- active: [os-quality](../topics/os-quality.md) - dejar en condiciones, calidad agentica, audit, contexto liviano, frontera AOS OMP
- active: [portable-multiharness-contract](../topics/portable-multiharness-contract.md) - frontera AOS OMP, contrato portable, multi-harness, launcher Pi
...
- No project-local skill directories found; `.agents/skills` remains valid harness discovery.
- Guidance: [local-codex-skills](../topics/local-codex-skills.md)

## AOS/OMP Boundary

- AOS keeps durable context, docs, indices, Working Memory, topics, tracks, specs, skills and local gates.
- The active OMP harness governs models, effort, tools, browser, todos, agents, planning, parallelism, language, style and runtime modes.
- Product Pi launcher and runtime remain outside the agentic context layer.
...
| WebView UI | Ventana HTML local renderizada con WebView2 desde AHK. |
...
| Capa AOS local | Conocimiento durable, docs, índices, Working Memory, topics, tracks, specs, skills y gates propios de Main. |
| Frontera AOS/OMP | AOS conserva contexto durable local; OMP gobierna su ejecución agentic y sus decisiones runtime. |
