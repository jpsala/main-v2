...
Global filesToCheckForReload := [
  ...
  {path: './browser.ahk', lastModVar: FileGetTime('./browser.ahk', "M")},
  {path: './keyboardSwitch.ahk', lastModVar: FileGetTime('./keyboardSwitch.ahk', "M")},
  ...
  {path: './obsidian.ahk', lastModVar: FileGetTime('./obsidian.ahk', "M")},
  {path: './discord.ahk', lastModVar: FileGetTime('./discord.ahk', "M")},
  {path: './telegram.ahk', lastModVar: FileGetTime('./telegram.ahk', "M")},
  {path: './xyplorer.ahk', lastModVar: FileGetTime('./xyplorer.ahk', "M")},
  {path: './terminal.ahk', lastModVar: FileGetTime('./terminal.ahk', "M")},
  {path: './database.ahk', lastModVar: FileGetTime('./database.ahk', "M")},
  {path: './media.ahk', lastModVar: FileGetTime('./media.ahk', "M")},
  {path: './teams.ahk', lastModVar: FileGetTime('./teams.ahk', "M")},
