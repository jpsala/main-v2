...
;
; To add itemss to any menu item:
; {key: "S", label: "Menu Item", items: [
;     {key: "A", label: "Sub Item A"},
;     {key: "B", label: "Sub Item B"}
; ]}
; example:
; !b:: {
;     options := {
;         waitml: 1000,
;         items: [
;             {key: "1", label: "Fold level 1"},
;             {key: "2", label: "Fold level 2"},
;             {key: "3", label: "Fold level 3"},
;             {key: "4", label: "Fold level 4"},
;             {key: "", label: ""}, ; Separator
;             {key: "C", label: "Fold at cursor level"},
;             {key: "I", label: "Fold at line level"},
;             {key: "P", label: "Fold at parent level"},
;             {key: "", label: ""}, ; Separator
;             {key: "U", label: "Fold"},
;             {key: "u", label: "Unfold"},
;             {key: "", label: ""}, ; Separator
;             {key: "s", label: "Send Operations", items: [
;                 {key: "a", label: "Send Alt+A"},
;                 {key: "b", label: "Send Ctrl+B"},
;                 {key: "c", label: "Send Win+C"},
;                 {key: "", label: ""}, ; Separator
;                 {key: "x", label: "Two-key items", items: [
;                     {key: "1", label: "Option X1"},   
;                     {key: "2", label: "Option X2"},
;                     {key: "3", label: "Option X3"}
;                 ]}
;             ]}
;         ]
;     }
;     keys := customMenu(options)
; ========================================
;  !b:: {
;      options := {
;          waitml: 1000,
...
;      keys := customMenu(options)
; }
; Test hotkey for items - press Alt+S to show a items directly
